...
const SYSTEM_PROMPT = `You are an outreach copywriter — an AI systems company that builds voice receptionists, SaaS platforms, and automation tools for small and medium businesses.
...
Products to reference based on fit:
...
Make it specific to their business type and likely pain points.`;
  ...
  try {
    ...
    return {
      success: true,
      data: {
        message: `Hi, I'm reaching out from outreach team of my company. We build AI-powered tools for businesses like ${profile.companyName} — voice receptionists, booking automation, and CRM systems. Would love to show you how we can save your team time. Interested?`,
      },
      fallback: true,
    };
  }
